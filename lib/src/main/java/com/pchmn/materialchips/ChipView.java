...
//            setChipBackgroundColor(mBackgroundColor);
    ...
    public void inflate(ChipInterface chip) {
        ...
        if(ev.validateEmail(mLabel)){
            int color = ResourcesCompat.getColor(getResources(), R.color.colorChipViewBackground, null); //with theme
            setChipBackgroundColor(color);
        }else{
            int color = ResourcesCompat.getColor(getResources(), R.color.colorWrongChip, null); //with theme
            setChipBackgroundColor(color);
        }
